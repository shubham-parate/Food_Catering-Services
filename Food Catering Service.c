...
void items ()
{
    ...
    printf(" 11]         Burger                     200/300 gm                 130/180\n");
    printf(" 12]         Chicken Pizza              12/14/16 inch              750/975/1250\n");
    ...
    printf(" 20]         Coke                       250/500 mg                 20/30\n\n");

}
int main ()
{
    printf ("\t\t     Welcome To AGRO CATERRING SERVICE\n");
    while (1){
        printf ("1. Order\n2. Serve\n3. Display \n4. Exit the program\n");
        ...
        switch (in){
            ...
            case 4 : {
                printf ("HAVE A GOOD DAY....VISIT US AGIAIN...\n\n");
                printf ("Project submitted by ROLL NO.: A- 19/23/24/25\n\n");
                printf ("Our hearty gratitude to honorable teacher \n\n");
                printf ("           MR. S.S.Rabade Sir       \n");
                return 0;
            }
        }
    }
